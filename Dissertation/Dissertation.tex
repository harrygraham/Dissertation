...
Word Count:         &  \bf 10,943\footnotemark \\
Project Originators: & H.~Graham \& B.~Dimanov \\
Supervisors:         & B.~Dimanov \& Dr M.~Jamnik
\end{tabular}
\footnotetext{Calculated with: Texcount Dissertation.tex (count for Chapter 1-5).}
}
...
\\
\hline
 \textbf{Baseline Models} & \textbf{CNN Models} \\
 &  \\
 KNearestNeighbors & \multirow{3}{5cm}{Model 1: Single Vector Input Approach} \\
 LinearSVC &  \\
 DecisionTreeClassifier&  \\
RandomForestClassifier& \multirow{3}{5cm}{Model 2: Time Series, Sliding Window Approach} \\
MLPClassifier& \\
GaussianNB& \\ \\
 \multicolumn{2}{c}{\textbf{GAN Models}} \\
 \\
 \multicolumn{2}{c}{Model 1: Dense Generator Network} \\
 \multicolumn{2}{c}{Model 2: Previous CNN as Generator Network} \\
  \multicolumn{2}{c}{General experimentation using GANs} \\
  \multicolumn{2}{c}{Extension: Semi Supervised GAN}\\ \hline
\end{tabular}}
\end{center}
...
\lstinputlisting[language=Python, caption=CNNv2 create\_model Function., label={lst:cnnv2-snippet-1}]{code-snippets/cnnv2-snippet-1.py}

\lstinputlisting[language=Python, caption=CNNv2 Generate Time Series Split Function., label={lst:cnnv2-data-split}]{code-snippets/cnnv2-data-split.py}
...
\lstinputlisting[language=Python, frame=single, caption= GAN v1 - Dense Generator., label={lst:ganv1-generator}]{code-snippets/ganv1-generator.py}
...
The project was a success as the work set out to be completed, was achieved. Implementation included extra work than first anticipated, including a novel extension. 
